...
<div id="j-main-container" class="span10">
	<form action="<?php echo Route::_('index.php?option=com_bookpro&view=routes'); ?>" method="post" name="adminForm" id="adminForm">
		<?php
		// Search tools bar
		...
		<table class="table">
			<thead>
				<tr>
					...
					<th width="5%"><?php echo Text::_('COM_BOOKPRO_CODE'); ?>

					<th width="5%"><?php echo Text::_('COM_BOOKPRO_COMPANY'); ?>
					</th>
					<th width="5%"><?php echo Text::_('COM_BOOKPRO_VEHICLE'); ?>
					</th>
			...
			<tbody>
				...
				?>
					<tr class="<?php if (($subject->price == 0) || !$subject->seattemplate_title) echo "warning";
						...
						<td>
							<a href="<?php echo Route::_('index.php?option=com_bookpro&task=route.edit&id=' . $subject->id); ?>">

								<span style="<?php if (!$subject->parent_id) echo "font-weight:bold;" ?>"><?php echo $subject->title; ?></span> </a>
						</td>
						<td><a href="<?php echo Uri::base() . 'index.php?option=com_bookpro&view=route&id=' . $subject->id ?>"><?php echo $subject->code; ?></a>
							<!-- <br /><a href="<?php echo Uri::base() . 'index.php?option=com_bookpro&view=route&id=' . $subject->id ?>"><?php echo Text::_('COM_BOOKPRO_VIEW_ROUTE_MAP'); ?></a> -->
						<td><?php echo $subject->company; ?>
						</td>
						<td><?php echo $subject->vehicle_name; ?>
						</td>
