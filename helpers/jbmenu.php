 ...
 * @since  1.5
 */
class JBAdminCssMenu extends JObject
{
	/**
	...
	public function __construct()
	{
		...
		$doc->addStyleSheet(JUri::base().'components/com_bookpro/assets/css/style.css');
		$doc->addStyleSheet(JUri::base().'components/com_bookpro/assets/css/style_default.css');
		$doc->addStyleSheet(JUri::base().'components/com_bookpro/assets/css/style_responsive.css');
		$doc->addStyleSheet(JUri::base().'components/com_bookpro/assets/css/font-awesome.css');
		$doc->addScript(JUri::base().'components/com_bookpro/assets/js/menu.js');
		
		
		$doc->addScript('//use.fontawesome.com/40fe7043c1.js');
		$this->_root = new JBMenuNode('ROOT');
	 ...
	 * @return  void
	 */
	public function addChild(JBMenuNode $node, $setCurrent = false)
	{
	...
	{
		//echo "<pre>";print_r($this->_current);die;
	...
	{
		$this->addChild(new JBMenuNode(null, null, 'separator', false));
	}
	...
	public function renderMenu($id = 'menu', $class = '')
	{
		...
		while ($this->_current->hasChildren())
		{
			...
			echo '<ul id="nav-empty" class=" nav-empty hidden-phone"></ul>';
		}
	...
	public function renderLevel($depth)
	{
		...
		if($this->_current->icon){
		$icon='<span class="icon-box"> <i class="fa fa-'.$this->_current->icon.'"></i></span>';
		}else{
			$icon='';
		}
		...
		{
			echo "<a" . $linkClass . " "  . " href=\"" . $this->_current->link . "\" target=\"" . $this->_current->target . "\" >"
					.$icon. $this->_current->title . $dropdownCaret . "</a>";
		}
		elseif ($this->_current->link != null && $this->_current->target == null)
		{
			echo "<a" . $linkClass . " "  . " href=\"" . $this->_current->link . "\">" . $icon .$this->_current->title . $dropdownCaret . "</a>";
		}
		elseif ($this->_current->title != null)
		{
			//echo "<a" . $linkClass . " " . ">" . ''. $this->_current->title . $dropdownCaret . "</a>";
		}
		else
		{
			echo "<span></span>";
 ...
 * @since  1.5
 */
class JBMenuNode extends JObject
{
	/**
	 * Node Title
	 *
	 ...
	 */
	public function __construct($title, $link = null, $class = null, $active = false, $target = null, $titleicon = null,$icon=null)
	{
	 ...
	 * @return  void
	 */
	public function addChild(JBMenuNode &$child)
	{
	 ...
	 * @return  void
	 */
	public function setParent(JBMenuNode &$parent = null)
	{
