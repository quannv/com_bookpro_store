 ...
 * @since  1.6
 */
class OperatorModel extends AdminModel
{
     ...
     * @since  3.2
     */
    public $typeAlias = 'com_bookpro.operator';
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_bookpro.operator', 'operator', ['control' => 'jform', 'load_data' => $loadData]);
