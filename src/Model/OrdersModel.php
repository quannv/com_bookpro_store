...
class OrdersModel extends ListModel
{
    ...
    protected function getListQuery()
    {
        ...
        $query->select('a.*');
        $query->select('c.firstname as customer_firstname, c.lastname as customer_lastname,c.email as customer_email,c.mobile as customer_mobile');
        $query->from('`#__bookpro_orders` AS a');
        $query->join('inner', '#__bookpro_customer AS c ON c.id=a.cid');
