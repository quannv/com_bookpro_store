 ...
 * @since  1.6
 */
class VehicleModel extends AdminModel
{
     ...
     * @since  3.2
     */
    public $typeAlias = 'com_bookpro.vehicle';
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_bookpro.vehicle', 'vehicle', ['control' => 'jform', 'load_data' => $loadData]);
