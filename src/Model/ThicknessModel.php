 ...
 * @since  1.6
 */
class ThicknessModel extends AdminModel
{
     ...
     * @since  3.2
     */
    public $typeAlias = 'com_bookpro.thichness';
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_bookpro.thickness', 'thickness', ['control' => 'jform', 'load_data' => $loadData]);
