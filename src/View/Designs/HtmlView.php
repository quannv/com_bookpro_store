...
namespace Joombooking\Component\Bookpro\Administrator\View\Designs;
...
use Joombooking\Component\Bookpro\Administrator\Model\BrandsModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    {
        ToolbarHelper::title(Text::_('Designs'), 'location');
        ToolBarHelper::addNew('design.add');
        ToolBarHelper::editList('design.edit');
        ToolBarHelper::divider();
        ToolBarHelper::publish('designs.publish', 'Publish', true);
        ToolBarHelper::unpublish('designs.unpublish', 'UnPublish', true);
        ToolBarHelper::divider();

        ToolBarHelper::deleteList('', 'designs.delete');
    }
}
