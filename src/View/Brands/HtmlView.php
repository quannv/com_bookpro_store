...
namespace Joombooking\Component\Bookpro\Administrator\View\Brands;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        ToolBarHelper::editList('brand.edit');
        ToolBarHelper::divider();
        ToolBarHelper::publish('brands.publish', 'Publish', true);
        ToolBarHelper::unpublish('brands.unpublish', 'UnPublish', true);
        ToolBarHelper::divider();

        ToolBarHelper::deleteList('', 'brands.delete');
    }
}
