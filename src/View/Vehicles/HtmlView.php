...
namespace Joombooking\Component\Bookpro\Administrator\View\Vehicles;
...
use Joombooking\Component\Bookpro\Administrator\Model\VehiclesModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    {
        ToolbarHelper::title(Text::_('COM_BOOKPRO_VEHICLES_MANAGER'), 'location');
        ToolBarHelper::addNew('vehicle.add');
        ToolBarHelper::editList('vehicle.edit');
        ToolBarHelper::divider();
        ToolBarHelper::publish('vehicles.publish', 'Publish', true);
        ToolBarHelper::unpublish('vehicles.unpublish', 'UnPublish', true);
        ToolBarHelper::divider();

        ToolBarHelper::deleteList('', 'vehicles.delete');
    }
}
