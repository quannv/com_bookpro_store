...
class BookProPaymentPlugin extends CMSPlugin
{
    /**
     ...
     */
    function _getNotificationUrl($order_number = null)
    {
        if ($order_number)
            return Uri::root() . "index.php?option=com_bookpro&controller=payment&task=postpayment&paction=process&method=" . $this->_element . "&order_number=" . $order_number;
        else
            return  Uri::root() . "index.php?option=com_bookpro&controller=payment&task=postpayment&paction=process&method=" . $this->_element;
    }
    function _getReturnUrl($order_number = null)
    {
        if ($order_number)
            return  URI::root() . "index.php?option=com_bookpro&controller=payment&task=postpayment&paction=display_message&method=" . $this->_element .
